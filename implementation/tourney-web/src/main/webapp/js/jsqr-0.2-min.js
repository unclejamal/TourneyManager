...
w[A].prototype.Input.prototype.toString=function(){
    ...
    switch(this.dataType){
        case this.DATA_TYPE.DEFAULT:case this.DATA_TYPE.TEXT:
...
break;
case b.ENCODE_MODE.BYTE:case b.ENCODE_MODE.UTF8:case b.ENCODE_MODE.UTF8_SIGNATURE:
    for(i=0;i<a.length;i++){
