...
public class PlayerFilter implements Serializable {
    ...
    public PlayerFilter(int rank, String code, String fullName, Gender gender, String city, String club, int points, int pointsAdded, int pointsDeleted, RankClass rankClass) {
        this.rank = rank;
        this.code = code;
    ...
    public boolean equals(Object obj) {
        ...
        final PlayerFilter other = (PlayerFilter) obj;
    ...
    public String toString() {
        return "PlayerFilter{" + "code=" + code + ", fullName=" + fullName + '}';
    }
}