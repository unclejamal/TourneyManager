...
public class WkpsFeeCalculatorTest {
    ...
    public void test() {
        ...
        assertEquals(30, cut.getFee(Licensed.LICENSED_AT_THIS_CLUB, 700, RankClass.MASTER));
        assertEquals(35, cut.getFee(Licensed.LICENSED_AT_OTHER_CLUB, 700, RankClass.MASTER));
        assertEquals(70, cut.getFee(Licensed.NOT_LICENCED, 700, RankClass.MASTER));
