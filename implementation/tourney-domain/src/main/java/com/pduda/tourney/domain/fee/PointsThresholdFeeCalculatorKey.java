...
public class PointsThresholdFeeCalculatorKey {

    private RankClass rankClass;
    private Licensed licenseType;

    public PointsThresholdFeeCalculatorKey(RankClass rankClass, Licensed licenseType) {
    ...
    public boolean equals(Object obj) {
        ...
        final PointsThresholdFeeCalculatorKey other = (PointsThresholdFeeCalculatorKey) obj;
